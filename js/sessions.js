...
export function generateTerrainSession(duration, pace, distance, intensity) {
  ...
  session["comment"] = "Get completely off-road (even away from the dirt trails if possible). This will help build your strength and also reduce the strain on any repetitive stress niggles. Aim for a speed that is not too fast, not too slow, just what feels comfortable. You should be a bit out of breath but able to speak in long sentences. You should be able to maintain the speed for up to 2 hours.";
...
export function generateLongSession(duration, pace, distance, intensity) {
  ...
  session["comment"] = "The focus of this session is duration, not speed. Aim for a speed that is not too fast, but not too slow. You should be a bit out of breath but able to speak in long sentences. Try doing this session with friends and talk at the same time  to keep it interesting.";
...
export function generateProgressionSession(duration, pace, distance, intensity) {
  ...
  session["comment"] = "The focus of the progression run is to build endurance and also practice pushing yourself when you are fatigued. You should run the first 60% of the time at approximately " + parseFloat(pace1).toFixed(2) + " mins/km, the next 20% at " + parseFloat(pace2).toFixed(2) + " mins/km, and the final 20% at " + parseFloat(pace3).toFixed(2) + " mins/km.";
...
export function generateThresholdRunSession(duration, pace, distance, intensity) {
  ...
  session["comment"] = "The threshold run aims to increase your body's ability to process lactate. You should aim to run at a speed that is comfortably hard and that you could maintain for 60 to 90 minutes. You should only be able to speak in short sentences and should out of breath but not hyperventilating. Your legs should also not feel heavy.";
...
export function generateThresholdShortIntSession(duration, pace, distance, intensity) {
  ...
  session["comment"] = "Run " + numReps + " sets of 10 minutes at threshold pace with 2 minutes easy rest between each. Threshold intervals aim to increase your body's ability to process lactate. You should aim to run the intervals at a speed that is comfortably hard and that you could maintain for 60 to 90 minutes. At this pace you should only be able to speak in short sentences and should out of breath but not hyperventilating. Your legs should also not feel heavy.";
...
export function generateThresholdLongIntSession(duration, pace, distance, intensity) {
  ...
  session["comment"] = "Run " + numReps + " sets of 15 minutes at threshold pace with 3 minutes easy rest between each. Threshold intervals aim to increase your body's ability to process lactate. You should aim to run the intervals at a speed that is comfortably hard and that you could maintain for 60 to 90 minutes. At this pace you should only be able to speak in short sentences and should out of breath but not hyperventilating. Your legs should also not feel heavy.";
...
export function generateTempoShortIntSession(duration, pace, distance, intensity) {
  ...
  session["comment"] = "Run " + numReps + " sets of 5 minutes at tempo pace with 1.5 minutes easy rest between each. Tempo intervals aim to get you used to running at a high speed. You should aim to run the intervals at a speed that is relatively hard, something around your 10km pace, and that you could maintain for 30 to 60 minutes. You should only be able to speak a few words at a time and should be very short of breath and hyperventilating slightly.";
...
export function generateTempoLongIntSession(duration, pace, distance, intensity) {
  ...
  session["comment"] = "Run " + numReps + " sets of 10 minutes at tempo pace with 3 minutes easy rest between each. Tempo intervals aim to get you used to running at a high speed. You should aim to run the intervals at a speed that is relatively hard, something around your 10km pace, and that you could maintain for 30 to 60 minutes. You should only be able to speak a few words at a time and should be very short of breath and hyperventilating slightly.";
